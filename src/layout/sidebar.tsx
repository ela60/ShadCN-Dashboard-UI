...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <>
      <aside
        className={cn(
          'fixed top-0 left-0 z-30 h-screen w-64 border-r bg-background hidden md:block',
          className
        )}
      >
      ...
      <div className="block md:hidden">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetTrigger asChild>
            <button className="fixed top-4 left-4 z-40 flex h-8 w-8 items-center justify-center rounded-md bg-background/50 backdrop-blur-sm">
